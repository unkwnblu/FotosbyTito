    ...
    >
          ...
          <div
            className={clsx(
              ...
              isDarkMode
                ...
                : "opacity-30 mix-blend-multiply filter contrast-125"
            )}
      ...
      >
        ...
        <motion.div variants={floatingVariant} animate="loop" className="px-4">
          ...
          >
            "This is more than photography. It’s how moments are remembered"
          </motion.p>
        </motion.div>
        ...
        <motion.div
          variants={itemVariants}
          className="flex flex-wrap justify-center gap-4 sm:gap-8 md:gap-16 mb-12 md:mb-20 items-baseline w-full"
        >
          <CountdownItem
            value={timeLeft.days}
            label="DAYS"
          ...
          <div
            className={clsx(
              "w-[1px] h-6 md:h-8 transition-colors duration-500",
              isDarkMode ? "bg-white/50" : "bg-stone-400"
            )}
          ></div>
          <CountdownItem
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={clsx(
            "absolute -top-20 -right-20 w-64 h-64 rounded-full blur-[80px] pointer-events-none opacity-40",
            isDarkMode ? "bg-white/10" : "bg-stone-300"
          )}
        />
                ...
                <Mail
                  className={clsx(
                    ...
                    isDarkMode
                      ...
                      : "text-stone-400 group-focus-within:text-stone-800"
                  )}
                />
                <input
                  name="email"
